          ...
          <div className="bg-neutral-900/80 border border-neon-green/20 rounded-xl p-8">
            <div className="space-y-4 text-gray-400">
              ...
              <p>
                ...
                <strong>Photos:</strong> To protect the privacy of our community, personal photography is strictly prohibited on the dancefloor and play areas. There will be an official event photographer taking selected photos.
              </p>
              <p>
